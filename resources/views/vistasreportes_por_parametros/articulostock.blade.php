@extends('layouts.app')
@section('title','Artículo/Producto en Stock')
  ...
  <div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <form action="{{route('r_articulostock')}}" method="POST">
              @csrf
                <div class="card card-info">
                  <div class="card-header">
                      Reporte de Artículo/Producto en Stock
                  </div>
                  <div class="card-body">
                    <div class="row">
                      <!-- === -->
