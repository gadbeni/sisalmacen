@extends('layouts.app')
@section('title','Resumen Egresos de Artículos/Producto')

@section('content')
  <div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <form action="{{route('egresosresumen_r')}}" method="POST">
              @csrf
                <div class="card card-info">
                  <div class="card-header">
                      Reporte de Egresos de Artículos/Producto (Resumen de Montos)
                  </div>
                  <div class="card-body">
                    <div class="row">
                      <!-- === -->
