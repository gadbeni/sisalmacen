@extends('layouts.app')
@section('title','Compra de Artículos por Proveedor')
  ...
  <div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <form action="{{route('r_articulo_proveedor')}}" method="POST">
              @csrf
                <div class="card card-info">
                  <div class="card-header">
                      Reporte de Compra de Artículos por Proveedor
                  </div>
                  <div class="card-body">
                    <div class="row">
                      <!-- === -->
                      ...
                      <div class="col-sm-8">
                        <div class="form-group">
                            <div class="form-line">
                                <select name="proveedor_id" class="form-control form-control-sm select2bs4">
